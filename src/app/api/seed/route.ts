...
const DEMO_TASKS = [
  ...
  { title: 'Upgrade Oakdale Kitchen PC from Win 7',             priority: 'high',   status: 'in_progress', reported_by: null,                 screen: null         },
  { title: 'Fix broken HP LaserJet in Business Office',         priority: 'medium', status: 'in_progress', reported_by: null,                 screen: null         },
  { title: "Set up Splashtop remote access for Tara D'Andrea",  priority: 'medium', status: 'in_progress', reported_by: "Tara D'Andrea",      screen: null         },
  { title: "Replace Bob Oriol's Intel NUC (warranty expired)",  priority: 'medium', status: 'in_progress', reported_by: 'Bob Oriol',          screen: null         },
  { title: 'Onboard new Activities coordinator',                priority: null,     status: 'in_progress', reported_by: null,                 screen: 'Onboarding' },
  { title: "Replace Jay Kublbeck's Oakdale Maintenance PC",     priority: 'low',    status: 'in_progress', reported_by: 'Jay Kublbeck',       screen: null         },
  { title: 'Set up second ThinkCentre for Danielle Mattei',     priority: 'medium', status: 'in_progress', reported_by: 'Danielle Mattei',    screen: null         },
  ...
  { title: 'Update asset tags after recent equipment moves',    priority: 'low',    status: 'in_progress', reported_by: null,                 screen: null         },
  // Queue (10)
  { title: "Upgrade Ildi's Activities Tower (Win 7, warranty expired 2015)", priority: 'high',   status: 'pending', reported_by: null,             screen: null         },
  ...
  { title: "Set up new laptop for Tara D'Andrea (home use)",    priority: 'medium', status: 'pending', reported_by: "Tara D'Andrea",    screen: null         },
  { title: 'Onboard new nurse in Wachusett wing',               priority: null,     status: 'pending', reported_by: null,               screen: 'Onboarding' },
  { title: "Replace Nathan Oriol's ThinkCentre (no warranty on file)", priority: 'medium', status: 'pending', reported_by: 'Nathan Oriol', screen: null         },
